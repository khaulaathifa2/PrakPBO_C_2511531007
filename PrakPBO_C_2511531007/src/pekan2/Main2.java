...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Rekening2> daftarRekening = new ArrayList<>(); // Menyimpan semua rekening
		Rekening2 akunAktif = null; // Objek belum dinisialisasi (null)
		boolean isRunning = true;
		 ...
		 while (isRunning) {
			 ...
			 System.out.println("7. Ringkasan Transaksi (challenge");
